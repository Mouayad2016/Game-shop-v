        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <Link to="/">
                    <img src="assets/images/logo.png" class="logo" heigth="30" width="60" alt=""/>
                    ...
                    <ul class="nav">
                        ...
                        <li class="scroll-to-section"><Link to="/cartpage"><img src="assets/images/cart2_green.png" alt="" height="27"
                    width="27"/></Link></li>
